...
const index = () => {
 ...
 const ref=useRef()
 const [img,setimg]=useState('b.png')
      ...
      <div className='mx-28' >
        <div className="p-2 w-1/2">
          <div className="relative">
            ...
            <input type="text" id="name" name="name" className="w-72 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
        </div>
        <div className="p-2 w-1/2 ">
          <div className="relative">
            <label for="email" className="leading-7 text-sm text-gray-600">Password</label>
            <input ref={ref} onChange={onChange} type="text" id="email" name="email" className="w-72 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
        </div>
        </div>
